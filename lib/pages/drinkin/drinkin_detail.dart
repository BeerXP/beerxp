...
class DrinkinDetailScreen extends StatefulWidget {
  final DocumentSnapshot documentSnapshot;
  final User user, currentuser;

  DrinkinDetailScreen({this.documentSnapshot, this.user, this.currentuser});

  @override
  _DrinkinDetailScreenState createState() => _DrinkinDetailScreenState();
}

class _DrinkinDetailScreenState extends State<DrinkinDetailScreen> {
    ...
    return Scaffold(
        ...
        body: Column(
          ...
          children: <Widget>[
            ...
            FutureBuilder(
              future: _repository.fetchDrinkinLikes(widget.documentSnapshot.reference),
              builder: ((context,
